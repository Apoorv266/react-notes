...
// In this tutorial we created a reusable function called updateNews() (line 29)

//When next button is pressed the state variable page get plus to 1 and updateNews() is called (line 94)

//When previous button is pressed the state variable page get subrtracted by 1 and updateNews() is called (line 74)

//The componentDidMount() also calls out updateNews() function