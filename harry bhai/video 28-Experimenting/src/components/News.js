...
export class News extends Component {
  ...
  // componentDidMount() is a life method and will run after render () function
  ...
  render() {
    return (
      <>
          ...
          <h2 className="text-center my-3" style={{color:this.props.TextCol}}>
